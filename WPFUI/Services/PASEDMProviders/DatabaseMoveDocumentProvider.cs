...
namespace PASEDM.Services.PASEDMProviders
{
    public class DatabaseMoveDocumentProvider : IMoveDocumentProvider
    {
        ...
        private MoveDocument ToMoveDoc(MoveDocumentDTO dto)
        {
            ...
            Document document = new(dto.Document.ID, dto.Document.NameDoc, dto.Document.RegistrationNumber, dto.Document.Summary, dto.Document.FileDoc, deadlines, secrecyStamps, docStages, documentTypes);
